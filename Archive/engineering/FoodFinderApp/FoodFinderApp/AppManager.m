...
-(BOOL) setRestaurantRating : (NSString *) idFSRestaurant : (int) rating
{
    return [_foodDatabaseConnector setRestaurantRating: _userName : _password : idFSRestaurant : rating ];
}
...
{
    [_foodDatabaseConnector setMenuItemComments:_userName :_password :idFSRestaurantItem :idFSMenuItem :comments];
}
@end
