...
-(Menu*) getRestaurantMenu : (NSString*) username : (NSString*) password : (NSString*) idFSRestaurant
{
    ...
    Menu *menu = [[Menu alloc] initWithMenuItems:responseString andRestaurantId:idFSRestaurant];
    return menu;
}

-(BOOL) setRestaurantRating : (NSString *) username : (NSString *) password : (NSString*) idFSRestaurant : (int) rating
{
    NSDictionary * getParams =
    @{
      @"username" : username,
    ...
    NSString* errorNumString = [self callPHPScript:@"setRestaurantRating" :getParams];
    int errorNum = [errorNumString intValue];
    return errorNum > 0;
}
...
-(void) setMenuItemComments:(NSString *)username :(NSString *)password :(NSString *)idFSRestaurant :(NSString *)idFSMenuItem :(NSString *)comments
{
    ...
    [self callPHPScript:@"setMenuItemComments" :getParams];
}
